            ...
            <div className="relative mb-20">
              <div className="relative aspect-square max-w-2xl mx-auto">
                ...
                <motion.div
                  ...
                  className="absolute inset-0 rounded-full bg-gradient-to-br from-primary/30 to-primary/20 border-[3px] border-primary shadow-glow flex flex-col items-center justify-start pt-8 md:pt-12"
                >
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-primary/30 flex items-center justify-center mx-auto mb-3">
                    <Heart className="w-5 h-5 md:w-6 md:h-6 text-primary" />
                  </div>
                  <h3 className="text-2xl md:text-3xl font-bold text-primary">WHY</h3>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="absolute inset-[20%] rounded-full bg-gradient-to-br from-primary/15 to-primary/5 border-[3px] border-primary/70 flex flex-col items-center justify-center"
                >
                  <h3 className="text-2xl md:text-3xl font-bold text-primary">HOW</h3>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="absolute inset-[40%] rounded-full bg-gradient-to-br from-accent/10 to-accent/5 border-[3px] border-accent/60 flex flex-col items-center justify-center"
                >
                  <h3 className="text-xl md:text-2xl font-bold text-accent">WHAT</h3>
                </motion.div>
              </div>
            </div>
